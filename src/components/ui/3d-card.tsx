...
export const CardContainer: React.FC<CardContainerProps> = ({
  ...
  return (
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      <div
        className={cn(
          "flex justify-center items-center dark:text-white",
          containerClassName
        )}
        style={{
          perspective: "1000px",
      ...
      >
        <div
          ...
          className={cn(
            "flex relative justify-center items-center transition-all duration-200 ease-linear dark:text-white",
            className
          )}
          style={{
...
export const CardBody: React.FC<CardBodyProps> = ({ children, className }) => {
  return (
    <div
      className={cn(
        "h-96 w-96 [transform-style:preserve-3d] [&>*]:[transform-style:preserve-3d] dark:bg-black dark:text-white",
        className
      )}
    >
      {children}
